...
val extreal_models_def = Define ‘
    extreal_models = (extreal_model1 \/ extreal_model2)’;
...
Theorem IN_MEASURABLE_BOREL_ADD__model1[local] :
    extreal_model1 ==>
...
Theorem IN_MEASURABLE_BOREL_ADD__model2[local] :
    extreal_model2 ==>
    !a f g h. sigma_algebra a /\ f IN measurable a Borel /\ g IN measurable a Borel /\
             (!x. x IN space a ==> (h x = f x + g x))
          ==> h IN measurable a Borel
...
Theorem IN_MEASURABLE_BOREL_SUB__model1[local] :
    extreal_model1 ==>
    !a f g h. sigma_algebra a /\ f IN measurable a Borel /\ g IN measurable a Borel /\
             (!x. x IN space a ==> (h x = f x - g x))
          ==> h IN measurable a Borel
...
Theorem IN_MEASURABLE_BOREL_SUB__model2[local] :
    extreal_model2 ==>
    !a f g h. sigma_algebra a /\ f IN measurable a Borel /\ g IN measurable a Borel /\
             (!x. x IN space a ==> (h x = f x - g x))
          ==> h IN measurable a Borel
...
Theorem integral_add_lemma__model1[local] :
    extreal_model1 ==>
    !m f f1 f2.
...
Theorem integral_add_lemma__model2[local] :
    extreal_model2 ==>
    !m f f1 f2.
       measure_space m /\ integrable m f /\
       integrable m f1 /\ integrable m f2 /\
...
Theorem FUBINI__custom :
    extreal_models ==> ^FUBINI_tm
Proof
    REWRITE_TAC [extreal_models_def]
 >> STRIP_TAC
 >| [ (* goal 1 (of 2) *)
      MATCH_MP_TAC FUBINI__model1 >> art [],
      (* goal 2 (of 2) *)
      MATCH_MP_TAC FUBINI__model2 >> art [] ]
QED
