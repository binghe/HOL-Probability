(* ----------------------------------------------------------------- *)
(* Lebesgue Theory defined on the extended reals                     *)
...
app load ["bossLib", "metisLib", "arithmeticTheory", "pred_setTheory", "prim_recTheory", "listTheory",
	  ...
	  "stringSimps", "listSimps", "extrealTheory", "rationalTheory", "measureTheory"];
...
open HolKernel Parse boolLib bossLib metisLib arithmeticTheory pred_setTheory prim_recTheory 
     ...
     rich_listTheory stringSimps listSimps extrealTheory rationalTheory measureTheory;
